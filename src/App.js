              ...
              <div className="bookshelf">
                ...
                <div className="bookshelf-books">
                  <ol className="books-grid">
                    <li>
                      <Book key="To Kill a Mockingbird"
              ...
              <div className="bookshelf">
                ...
                <div className="bookshelf-books">
                  <ol className="books-grid">
                    ...
                    <li>
                      <Book key="Harry Potter and the Sorcerer's Stone"
              ...
              <div className="bookshelf">
                ...
                <div className="bookshelf-books">
                  <ol className="books-grid">
                    ...
                    <li>
                      <Book key="Oh, the Places You'll Go!"
                    ...
                    <li>
                      <Book key="The Adventures of Tom Sawyer"
